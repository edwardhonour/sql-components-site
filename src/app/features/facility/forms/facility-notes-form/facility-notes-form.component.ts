...
@Component({
  selector: 'app-facility-notes-form',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-notes-form.component.html',
  styleUrls: ['./facility-notes-form.component.css']
})
export class FacilityNotesFormComponent  implements OnChanges, OnInit {
