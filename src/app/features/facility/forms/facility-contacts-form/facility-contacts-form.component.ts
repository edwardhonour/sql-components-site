...
@Component({
  selector: 'app-facility-contacts-form',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-contacts-form.component.html',
  styleUrls: ['./facility-contacts-form.component.css']
})
export class FacilityContactsFormComponent implements OnChanges, OnInit {
    
  facility_id: any;
  contact_id: any;
  @Input() facility: any = '-1';
  @Input() contact: any = '-1';
...
getForm() {
  let inputForm: any = {
    ...
    stakeholder_id: this.contact_id
  }
