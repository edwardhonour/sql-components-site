...
@Component({
  selector: 'app-facility-tenant-form-old',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-tenant-form.component.html',
  styleUrls: ['./facility-tenant-form.component.css']
})
export class OldFacilityTenantFormComponent implements OnChanges, OnInit {
