...
@Component({
  selector: 'app-facility-saa-form',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-saa-form.component.html',
  styleUrls: ['./facility-saa-form.component.css']
})
export class FacilitySaaFormComponent implements OnChanges, OnInit {
...
getForm() {
  ...
  this._dataService.postForm("get-saa-form", inputForm).subscribe((data:any)=>{
    this.data=data;
  });
}
