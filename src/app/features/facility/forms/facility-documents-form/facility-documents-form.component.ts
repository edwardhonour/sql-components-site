...
@Component({
  selector: 'app-facility-documents-form',
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule],
  templateUrl: './facility-documents-form.component.html',
  styleUrls: ['./facility-documents-form.component.css']
})
export class FacilityDocumentsFormComponent implements OnChanges, OnInit {
