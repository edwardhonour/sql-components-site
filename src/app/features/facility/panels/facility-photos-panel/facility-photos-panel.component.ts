...
@Component({
  selector: 'app-facility-photos-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-photos-panel.component.html',
  styleUrls: ['./facility-photos-panel.component.css']
})
export class FacilityPhotosPanelComponent implements OnChanges, OnInit {
