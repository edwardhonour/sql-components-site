...
@Component({
  selector: 'app-facility-fsb-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, MatCheckboxModule, MatCardModule],
  templateUrl: './facility-fsb-panel.component.html',
  styleUrls: ['./facility-fsb-panel.component.css']
})
export class FacilityFsbPanelComponent implements OnChanges, OnInit {
