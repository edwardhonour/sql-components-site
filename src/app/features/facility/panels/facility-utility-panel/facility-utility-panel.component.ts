...
@Component({
  selector: 'app-facility-utility-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-utility-panel.component.html',
  styleUrls: ['./facility-utility-panel.component.css']
})
export class FacilityUtilityPanelComponent implements OnChanges, OnInit {
