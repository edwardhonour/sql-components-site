...
@Component({
  selector: 'app-facility-degraded-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-degraded-panel.component.html',
  styleUrls: ['./facility-degraded-panel.component.css']
})
export class FacilityDegradedPanelComponent implements OnChanges, OnInit {
