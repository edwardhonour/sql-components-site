...
@Component({
  selector: 'app-facility-history-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-history-panel.component.html',
  styleUrls: ['./facility-history-panel.component.css']
})
export class FacilityHistoryPanelComponent  implements OnChanges, OnInit {
