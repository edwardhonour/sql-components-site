...
@Component({
  selector: 'app-facility-cyber-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-cyber-panel.component.html',
  styleUrls: ['./facility-cyber-panel.component.css']
})
export class FacilityCyberPanelComponent implements OnChanges, OnInit {
