...
@Component({
  selector: 'app-facility-dashboard-info-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-dashboard-info-panel.component.html',
  styleUrls: ['./facility-dashboard-info-panel.component.css']
})
export class FacilityDashboardInfoPanelComponent  implements OnChanges, OnInit {
