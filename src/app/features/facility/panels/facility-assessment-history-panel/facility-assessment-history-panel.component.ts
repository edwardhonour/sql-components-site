...
@Component({
  selector: 'app-facility-assessment-history-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-assessment-history-panel.component.html',
  styleUrls: ['./facility-assessment-history-panel.component.css']
})
export class FacilityAssessmentHistoryPanelComponent implements OnChanges, OnInit {
