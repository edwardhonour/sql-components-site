...
@Component({
  selector: 'app-facility-illumination-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-illumination-panel.component.html',
  styleUrls: ['./facility-illumination-panel.component.css']
})
export class FacilityIlluminationPanelComponent  implements OnChanges, OnInit {
