...
@Component({
  selector: 'app-facility-saa-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, FacilitySaaFormComponent],
  templateUrl: './facility-saa-panel.component.html',
  styleUrls: ['./facility-saa-panel.component.css']
})
export class FacilitySaaPanelComponent implements OnChanges, OnInit {
