...
@Component({
  selector: 'app-facility-preview-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-preview-panel.component.html',
  styleUrls: ['./facility-preview-panel.component.css']
})
export class FacilityPreviewPanelComponent  implements OnChanges, OnInit {
