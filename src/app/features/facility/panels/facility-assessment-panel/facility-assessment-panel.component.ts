...
@Component({
  selector: 'app-facility-assessment-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-assessment-panel.component.html',
  styleUrls: ['./facility-assessment-panel.component.css']
})
export class FacilityAssessmentPanelComponent implements OnChanges, OnInit {
