...
@Component({
  selector: 'app-facility-recommended-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-recommended-panel.component.html',
  styleUrls: ['./facility-recommended-panel.component.css']
})
export class FacilityRecommendedPanelComponent implements OnChanges, OnInit {
