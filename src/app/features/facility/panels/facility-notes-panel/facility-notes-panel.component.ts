...
@Component({
  selector: 'app-facility-notes-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-notes-panel.component.html',
  styleUrls: ['./facility-notes-panel.component.css']
})
export class FacilityNotesPanelComponent implements OnChanges, OnInit {
