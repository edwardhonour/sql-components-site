...
@Component({
  selector: 'app-facility-crime-stats-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, GoogleMapsModule],
  templateUrl: './facility-crime-stats-panel.component.html',
  styleUrls: ['./facility-crime-stats-panel.component.css']
})
export class FacilityCrimeStatsPanelComponent implements OnChanges, OnInit {
