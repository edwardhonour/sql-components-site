...
@Component({
  selector: 'app-facility-threat-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-threat-panel.component.html',
  styleUrls: ['./facility-threat-panel.component.css']
})
export class FacilityThreatPanelComponent implements OnChanges, OnInit {
