...
@Component({
  selector: 'app-facility-log-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-log-panel.component.html',
  styleUrls: ['./facility-log-panel.component.css']
})
export class FacilityLogPanelComponent implements OnChanges, OnInit {
