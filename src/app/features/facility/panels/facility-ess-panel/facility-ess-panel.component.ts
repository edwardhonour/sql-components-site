...
@Component({
  selector: 'app-facility-ess-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './facility-ess-panel.component.html',
  styleUrls: ['./facility-ess-panel.component.css']
})
export class FacilityEssPanelComponent implements OnChanges, OnInit {
