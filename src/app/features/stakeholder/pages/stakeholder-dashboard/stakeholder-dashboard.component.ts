...
import { StakeholderInfoPanelComponent } from '../../panels/stakeholder-info-panel/stakeholder-info-panel.component'; 
import { TopMenuPanelComponent } from 'src/app/layout/panels/top-menu-panel/top-menu-panel.component'; 
import { FacilityMapPanelComponent } from 'src/app/features/facility/panels/facility-map-panel/facility-map-panel.component'; 
...
@Component({
  ...
  imports: [CommonModule,VertSideNavComponent,
    RouterModule,
    Ng2SearchPipeModule, StakeholderInfoPanelComponent,
    NgxTablePaginationModule, MatRadioModule,  FacilityMapPanelComponent,
    FormsModule,  CalendarPanelComponent, TopMenuPanelComponent],
  templateUrl: './stakeholder-dashboard.component.html',
  styleUrls: ['./stakeholder-dashboard.component.css']
})
export class StakeholderDashboardComponent implements OnInit, OnDestroy
{
